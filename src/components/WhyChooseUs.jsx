            ...
            >
              ...
              >
                <div className="flex flex-col gap-3">
                  ...
                  <span className="font-black text-slate-900 text-sm leading-tight">Advanced Training Methodology</span>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10">
            {benefits.map((benefit, index) => {
              const cardImages = [IMG_8599, IMG_8604, IMG_8622, vasa];
              return (
                <motion.div
                  key={index}
                ...
                >
                  <div className="relative h-full overflow-hidden rounded-[2rem] md:rounded-[3rem] p-1 transition-all duration-500">
                    
                    {/* Live Asset Background */}
                    <img 
                      src={cardImages[index % cardImages.length]} 
                      alt="" 
                      className="absolute inset-0 w-full h-full object-cover duration-700"
                    />
